...
RSpec.describe College, type: :model do
  describe 'Criando uma instancia nova' do
    it 'valid com os valores corretos' do
      college = build(:college)
      expect(college.valid?).to be(true)
    end

    context 'Campos obrigatórios sem o preenchimento' do
    ...
    context 'Do preenchimento do CEP' do
    ...
    context 'Do preencimento do Telefone' do
