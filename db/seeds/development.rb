...
admin = User.create!(name: 'Admin', iduff: '11111111110', admin: true, active: true, password: '123')
user = User.create!(name: 'User', iduff: '11111111114', admin: false, active: true, password: '123')
